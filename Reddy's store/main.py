...
app = FastAPI(title="Reddy's Store E-Commerce Platform API")
...
=================================================="""\
    ...
    return StreamingResponse(
        ...
        headers={"Content-Disposition": f"attachment; filename=reddys_invoice_{order_id}.txt"}
    )
